...
def render_graph_ReSTIR_FG():
    ...
    g.create_pass('ReSTIR_FG', 'ReSTIR_FG', {
        'PhotonBufferSizeGlobal': 400000, 
        'PhotonBufferSizeCaustic': 400000, 
        'AnalyticEmissiveRatio': 0.3499999940395355, 
        'PhotonBouncesGlobal': 10, 
        'PhotonBouncesCaustic': 10, 
        'PhotonRadiusGlobal': 0.019999999552965164, 
        'PhotonRadiusCaustic': 0.00800000037997961, 
        'EnableStochCollect': True, 
        'StochCollectK': 3, 
        'EnablePhotonCullingGlobal': True, 
        'EnablePhotonCullingCaustic': True, 
        'CullingRadius': 0.10000000149011612, 
        'CullingBits': 20, 
        'CausticCollectionMode': 3, 
        'CausticResamplingMode': 2, 
        'NumDispatchedPhotons': 822784})
...
# Scene
m.loadScene('sibenik_withStatue/sibenik_withGlasStatue.pyscene')
